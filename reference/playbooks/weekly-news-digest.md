...
2. **Pull EDGAR submissions JSON** — `curl -s -A "Pemberton/1.0 (subagent-team-harness) <email>" "https://data.sec.gov/submissions/CIK<company-CIK>.json"`. EDGAR requires a User-Agent header. Without it, requests get 403.
